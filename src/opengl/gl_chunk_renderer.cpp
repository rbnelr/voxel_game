...
void Raytracer::draw (OpenglRenderer& r, Game& game) {
	...
	r.state.bind_textures(shad, {
		...
		{"vct_col", vct_data.tex_col, vct_data.sampler},
		{"vct_alphNX", vct_data.tex_alph[0], vct_data.sampler},
		{"vct_alphPX", vct_data.tex_alph[1], vct_data.sampler},
		{"vct_alphNY", vct_data.tex_alph[2], vct_data.sampler},
		{"vct_alphPY", vct_data.tex_alph[3], vct_data.sampler},
		{"vct_alphNZ", vct_data.tex_alph[4], vct_data.sampler},
		{"vct_alphPZ", vct_data.tex_alph[5], vct_data.sampler},
